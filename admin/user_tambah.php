...
<header>
    <div class="container" id="maincontent">
        <div style="margin: 5 0 5 0">
            <center>
                <h3 style="color: black;">Tambah User</h3>
        ...
        <form id="user_tambah" name="user_tambah" method="post" action="user_insert.php">
            <table width="90%" align="center" cellpadding="0" cellspacing="0" style="border-color: #C4DAE8; font-size: small;">
                <tr>
                    <td>Nama Lengkap</td>
                    <td>:</td>
                    <td><input type="text" name="nama" id="nama" size="50" style="color: black;"/></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><textarea name="alamat" id="alamat" style="width: 350px; height: 200px; color: black"></textarea></td>
                </tr>
                <tr>
                    <td>Email</td>
                    <td>:</td>
                    <td><input type="text" name="email" id="email" size="50" style="color: black;" /></td>
                </tr>  
                <tr>
                    <td>Username</td>
                    <td>:</td>
                    <td><input type="text" name="username" id="username" size="50" style="color: black;" /></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td>:</td>
